   ...
   return (
    <>
      <header className="header">
        ...
        <nav className='header-right'>
          <div className='header-navigation'>
              ...
              <li><a href='/' className='link white-text nav-item'>Home</a></li>
              <li><a href='/' className='link white-text nav-item'>Live</a></li>
              <li><a href='/' className='link white-text nav-item'>Music</a></li>
              <li><a href='/' className='link white-text nav-item'>Charts</a></li>
              <li><a href='/' className='link white-text nav-item'>Events</a></li>
              <li><a href='/' className='link white-text nav-item'>Features</a></li>
      ...
      <footer className='footer'>
        <div className="casual-text gray-text">
